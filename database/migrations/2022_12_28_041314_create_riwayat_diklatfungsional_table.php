...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('riwayat_diklatfungsional', function (Blueprint $table) {
            $table->comment('');
            $table->integer('id_diklatfungsional', true);
            ...
            $table->integer('id_pelfung')->default(0);
    ...
    {
        Schema::dropIfExists('riwayat_diklatfungsional');
    }
};

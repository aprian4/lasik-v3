                ...
                <div class="grid grid-cols-12 gap-6 mt-0">
                    <div class="col-span-12 grid grid-cols-12 gap-6 mt-3">
                        ...
                        <div class="col-span-12 sm:col-span-6 2xl:col-span-4 intro-y">
                            <center>
                                <div class="box p-5 zoom-in">
                                    <img src="images/icon/apik.png" alt="" sizes="100" srcset="">
                                    <div class="text-lg font-medium truncate mt-2">APIK</div>
                                    <div class="text-slate-500 mb-5">Aplikasi Penilaian Kinerja</div>
                                </div>
                            </center>
                        </div>
                        <div class="col-span-12 sm:col-span-6 2xl:col-span-4 intro-y">
